...
public:
	...
	void Preduction(const Poly64& a);
  	void head_reduction(const Poly64& a);
	void Phead_reduction(const Poly64& a);
...
inline Poly64::ConstIterator Poly64::begin() const
{
  	return mHead;
}

inline Poly64::Iterator Poly64::begin()
{
  	return mHead;
}

inline bitset<64> Poly64::Pnmv() const
{
  	return mHead->Pnmv();
}
